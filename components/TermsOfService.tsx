    ...
    >
      <View className="flex-1 bg-white">
        ...
        <ScrollView className="flex-1 px-5 py-6" contentContainerStyle={{ paddingBottom: 30 }}>
          ...
          <View className="mb-4">
            <Text className="text-base font-semibold text-gray-800 mb-2">4.3. AUSNUT database</Text>
            <Text className="text-sm text-textSecondary leading-6 mb-3">
              The Service may use AUSNUT (AUStralian Food and NUTrient Database) food and nutrient data as reference data for Australian food names, nutrient profiles, and meal recommendation logic where available. AUSNUT is published by Food Standards Australia New Zealand (FSANZ).
            </Text>
            <Text className="text-sm text-textSecondary leading-6 mb-3">
              AUSNUT content is third-party data. FSANZ does not endorse GoodHealthMate or our use of AUSNUT data, and nutritional values should be independently verified when accuracy matters for health, allergies, or dietary restrictions. Attribution: (c) Food Standards Australia New Zealand.
            </Text>
            <TouchableOpacity
              accessibilityRole="link"
              className="self-start"
              onPress={() => handleOpenExternalLink(AUSNUT_WEBSITE_URL)}
            >
              <Text className="text-sm font-semibold text-primary underline">
                AUSNUT database website
              </Text>
            </TouchableOpacity>
          </View>

          <View className="mb-4">
            <Text className="text-base font-semibold text-gray-800 mb-2">4.4. USDA FoodData Central</Text>
            <Text className="text-sm text-textSecondary leading-6 mb-3">
          ...
          <View className="mb-4">
            <Text className="text-base font-semibold text-gray-800 mb-2">4.5. Open Food Facts</Text>
            <Text className="text-sm text-textSecondary leading-6 mb-3">
          ...
          <View className="mb-4">
            <Text className="text-base font-semibold text-gray-800 mb-2">4.6. Food recognition datasets</Text>
            <Text className="text-sm text-textSecondary leading-6 mb-3">
          ...
          <View className="mb-6">
            <Text className="text-base font-semibold text-gray-800 mb-2">4.7. FatSecret Attribution</Text>
            <Text className="text-sm text-textSecondary leading-6">
